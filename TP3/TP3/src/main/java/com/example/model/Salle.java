...
public class Salle {
    ...
    // la Relation OneToMany avec Réservation
    ...
    // Constructeur par défaut qui est requis par JPA
    public Salle() {
    ...
    //  des Méthodes utilitaires pour gérer la relation bidirectionnelle avec Réservation
    ...
    // des Méthodes utilitaires pour gérer la relation ManyToMany avec Équipement
